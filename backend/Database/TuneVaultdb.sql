...
VALUES
    (@M1, N'Lần Cuối', '/lancuoi.mp3', NULL, 210, 0, 'U1', @Artist1Id, @Album1Id),
    (@M2, N'Em Dạo Này', 'https://res.cloudinary.com/dec7kmvib/video/upload/v1781081282/emdaonay_ffabqb.mp3', NULL, 195, 0, 'U1', @Artist1Id, @Album1Id),
